...
- **710+ unit tests** — comprehensive coverage of instruction encoding, addressing modes, arithmetic, branching, and assembler features
...
└── UnitTest/       Test DLL — Microsoft Native CppUnitTest (710+ tests)
```
