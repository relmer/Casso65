...
public:
    ...
    static void Pull                 (Cpu & cpu, Byte * registerAffected);
    static void Pop                  (Cpu & cpu, Byte * registerAffected);
    ...
    static void Transfer             (Cpu & cpu, Byte & sourceRegister, Byte & destinationRegister);
